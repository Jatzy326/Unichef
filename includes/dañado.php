<?php 
    ...
    // Consulta a la base de datos según el estatus seleccionado
    $sql = "SELECT id_articulo, nombre, categoria, cantidad, descripcion, imagen FROM articulos";
    if ($selectedStatus) {
        $sql .= " WHERE estatus = ?";
    }
...
<body>
    <div class="container">
        <?php
            ...
            // Define el título basado en el estatus
            switch ($estatus) {
                case 'Donado':
                    $titulo = 'Artículos  Donados';
                    break;
                case 'Perdido':
        ...
        <div class="content">
            ...
            <a href="fpdf/fpdf186/print_dona.php?estatus=<?php echo htmlspecialchars($selectedStatus, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary mb-3">Imprimir PDF <i class='fas fa-print'></i></a>
            ...
            <table id="tablaArticulos" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <tbody class="text-center">
                    <?php if ($articulos): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan='7'> No se encontraron registros de artículos</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
